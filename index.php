...
if(!function_exists('is_plugin_active') || function_exists('is_plugin_active') && is_plugin_active("mf_base/index.php"))
{
	...
	if(is_admin())
	{
		...
		add_filter('filter_base_page_index', array($obj_custom_login, 'filter_base_page_index'));
	...
	else
	{
		...
		add_action('resetpass_form', array($obj_custom_login, 'resetpass_form'));
	}
	...
	add_filter('login_url', array($obj_custom_login, 'login_url'), 10, 2);
		...
		add_filter('authenticate', array($obj_custom_login, 'authenticate'), 20, 3);
